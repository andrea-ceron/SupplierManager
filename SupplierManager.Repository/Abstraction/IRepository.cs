...
namespace SupplierManager.Repository.Abstraction
{
    public interface IRepository
    {
		...
		public Task DeleteOrderAsync(Order order, CancellationToken ct = default);
		public Task DeleteAllOrderBySupplierIdAsync(List<Order> orderList, CancellationToken ct = default);
		...
		public Task DeleteAllProductsBySupplierIdAsync(List<Product> productList, CancellationToken ct = default);
